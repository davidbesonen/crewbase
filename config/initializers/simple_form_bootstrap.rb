...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, class: "mb-3" do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: "form-label fw-semibold text-body-secondary"
  ...
  config.wrappers :vertical_boolean, tag: "fieldset", class: "mb-3" do |b|
    ...
    b.wrapper :form_check_wrapper, class: "form-check" do |bb|
      ...
      bb.use :label, class: "form-check-label fw-semibold text-body-secondary"
  ...
  config.wrappers :horizontal_form, class: "row mb-3" do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: "col-sm-3 col-form-label fw-semibold text-body-secondary"
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: "form-check", item_label_class: "form-check-label", class: "row mb-3" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: "col-sm-3 col-form-label pt-0 fw-semibold text-body-secondary"
    b.wrapper :grid_wrapper, class: "col-sm-9" do |ba|
  ...
  config.wrappers :inline_form, class: "col-12" do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: "visually-hidden fw-semibold text-body-secondary"
  ...
  config.wrappers :floating_labels_form, class: "form-floating mb-3" do |b|
    ...
    b.optional :readonly
    b.use :input, class: "form-control", error_class: "is-invalid", valid_class: "is-valid"
    b.use :label, class: "fw-semibold text-body-secondary"
    b.use :full_error, wrap_with: { class: "invalid-feedback" }
    b.use :hint, wrap_with: { class: "form-text" }
  end
